library flutter_background_service_plus;

import 'dart:async';

import 'package:flutter_background_service_plus_platform_interface/flutter_background_service_plus_platform_interface.dart';

export 'package:flutter_background_service_plus_platform_interface/flutter_background_service_plus_platform_interface.dart'
    show IosConfiguration, AndroidConfiguration, ServiceInstance, AndroidForegroundType;

export 'package:flutter_background_service_plus_android/flutter_background_service_plus_android.dart';
export 'package:flutter_background_service_plus_ios/flutter_background_service_plus_ios.dart';
