...
public class BackgroundService extends Service implements MethodChannel.MethodCallHandler {
    ...
    private void runService() {
        try {
            ...
            dartEntrypoint = new DartExecutor.DartEntrypoint(flutterLoader.findAppBundlePath(), "package:flutter_background_service_plus_android/flutter_background_service_plus_android.dart", "entrypoint");
