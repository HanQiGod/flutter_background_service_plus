package id.flutter.flutter_background_service_plus;
            ...
            if (!config.isManuallyStopped() && !isRunning) {
                try {
                    if (config.isForeground()) {
                        ContextCompat.startForegroundService(context, new Intent(context, id.flutter.flutter_background_service_plus.BackgroundService.class));
                    } else {
                        context.getApplicationContext().startService(new Intent(context, id.flutter.flutter_background_service_plus.BackgroundService.class));
                    }}
                catch (Exception e){
                    e.printStackTrace();
                }
